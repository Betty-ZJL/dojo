...
class Klass{
    ...
    assignLeader(student){
        if(this.number===student.klass.number) {
           ...
           for (let tec of teacher) {
                if (tec.isTeaching(student)) {
                    console.log(`I am ${tec.name}. I know ${student.name} has become Leader of Class ${this.number}.`);
                }
            }
        }
        else
    ...
    appendMember(student){
        ...
        for(let tec of teacher){
            if(tec.isTeaching(student)){
                console.log(`I am ${tec.name}. I know ${student.name} has join Class ${this.number}.`);
            }
        }
    }
    isIn(classes){
